...
namespace CSharpBootCamp301.PresentationLayer
{
    public partial class FrmProduct : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Product delete is successfully!");
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            product.ProductDecription= txtDesc.Text;    
            product.ProductStock= int.Parse(txtProductStock.Text);
            _productService.TInsert(product);
            MessageBox.Show("Product add is successfully!");
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            value.ProductDecription = txtDesc.Text;
            ...
            MessageBox.Show("Product update is successfully!");
